...
{
    if (keyboard_check_pressed(vk_escape) || gamepad_button_check_pressed(global.P1_input, gp_start))
    {
        if (!pausemenu)
        {
...
master.mouselock = false;
if (!transition_happening && !pausemenu && (keyboard_check_pressed(vk_tab) || (logmenu && (keyboard_check_pressed(vk_escape) || gamepad_button_check_pressed(global.P1_input, gp_start)))))
{
...
else
{
    ...
    else
    {
        ...
        else
        {
            switch (spacebar_mook_or_megalo_mode)
            {
                case 1:
                    ...
                    if (talkmenu)
                    {
                        talkmenu = keyboard_check(vk_space) || global.gamepad_select;
                    }
                    else
                    {
                        talkmenu = (keyboard_check_pressed(vk_space) || global.gamepad_select) && lobby.interact_anim == 1;
                    }
        ...
        if (keyboard_check(vk_space) || !global.gamepad_select)
        {
            ui_space_frame = 1;
        }
        else if (!keyboard_check(vk_space) || !global.gamepad_select)
        {
