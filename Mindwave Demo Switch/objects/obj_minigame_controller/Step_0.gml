...
if (((keyboard_check_pressed(vk_escape) || gamepad_button_check_pressed(global.P1_input, gp_start)) || (master.settings.pause_on_lose_focus && !master.game_focused)) && !game_ended && allow_pause)
{
    if (game_get_pause())
    {
    }
