function csev_dialogue_constructor0() : csev_base_constructor() constructor
{
    ...
    _tick = function()
    {
        ...
        else
        {
            ...
            if (!logopen && (keyboard_check_pressed(vk_escape) || gamepad_button_check_pressed(global.P1_input, gp_start)))
            {
                pause_menu.open();
            }
        }
        ...
        var continue_btn = ((mouse_check_button_pressed(mb_left) || keyboard_check_pressed(vk_space) || global.gamepad_select) && allow_player_input) || skip_line;
