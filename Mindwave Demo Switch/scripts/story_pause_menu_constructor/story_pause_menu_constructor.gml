function story_pause_menu_constructor() : menu_constructor() constructor
{
    ...
    open = function()
    {
        ...
        esc_held_start = keyboard_check_pressed(vk_escape) || gamepad_button_check_pressed(global.P1_input, gp_start);
    };
    ...
    tick = function()
    {
        ...
        {
            _tick();
            if (!esc_held_start && keyboard_check_pressed(vk_escape) || gamepad_button_check_pressed(global.P1_input, gp_start))
            {
                buttons[0].onclick();
            }
        }
