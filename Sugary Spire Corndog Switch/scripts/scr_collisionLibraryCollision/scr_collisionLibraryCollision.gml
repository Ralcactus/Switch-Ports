...
{
    var collided = 0;
    var check_slopes = (UnknownEnum.Value_1 & arg2) != UnknownEnum.Value_1;
    var check_solids = (UnknownEnum.Value_2 & arg2) != UnknownEnum.Value_2;
    var check_platforms = (UnknownEnum.Value_8 & arg2) != UnknownEnum.Value_8;
    var check_moving = (UnknownEnum.Value_4 & arg2) != UnknownEnum.Value_4;
...
function instance_place_list_movingPlatform(arg0, arg1, arg2 = obj_movingPlatform, arg3 = undefined)
{
    var collided = 0;
...
function place_meeting_movingPlatform(arg0, arg1, arg2 = obj_movingPlatform)
{
    return instance_place_list_movingPlatform(arg0, arg1, arg2) > 0;
}

function position_meeting_movingPlatform(arg0, arg1, arg2 = obj_movingPlatform)
{
    var old_mask = mask_index;
    mask_index = spr_pixel;
