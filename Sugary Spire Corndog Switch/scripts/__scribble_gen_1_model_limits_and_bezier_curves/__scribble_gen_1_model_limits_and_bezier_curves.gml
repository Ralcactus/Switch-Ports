function __scribble_gen_1_model_limits_and_bezier_curves()
{
    ...
    if (_bezier_do)
    {
        ...
        if (_model_max_width >= 0)
            __scribble_trace("Warning! Maximum width set by scribble_set_wrap() (" + string(_model_max_width) + ") has been replaced with Bezier curve length (" + string(_dist) + "). Use -1 as the maximum width to turn off this warning");
