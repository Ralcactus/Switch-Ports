function scr_confecti_init()
{
    ...
    switch (object_index)
    {
        ...
        case obj_icegrandson:
            ...
            spr_runpanic = spr_icegrandson;
            spr_panic = spr_icegrandson;
            spr_appear = spr_icegrandson;
            spr_taunt = spr_icegrandson;
        ...
        case obj_donut_mines_collect:
            spr_idle = spr_donut_boil;
            spr_run = spr_donut_fly;
            spr_runpanic = spr_donut_boil;
            spr_panic = spr_donut_boil;
            spr_appear = spr_donut_boil;
            spr_taunt = spr_bigDonut_fly;
            global.Donutfollow = true;
            break;
    }
}
