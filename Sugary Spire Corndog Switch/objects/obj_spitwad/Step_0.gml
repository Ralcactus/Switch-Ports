...
if (point_in_rectangle(obj_parent_player.x, obj_parent_player.y, x - 300, y - 60, x + 300, y + 60) && obj_parent_player.state != UnknownEnum.Value_72 && obj_parent_player.state != UnknownEnum.Value_57)
{
