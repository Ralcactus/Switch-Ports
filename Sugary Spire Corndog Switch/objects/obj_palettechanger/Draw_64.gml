...
if (!surface_exists(surface))
{
    ...
    with (player)
    {
        ...
        pal_swap_draw_palette(paletteSprite, 0, 0, 0);
        pal_swap_draw_palette(paletteSprite, paletteSelect, 1, 0);
...
if (surface_exists(surface))
{
    ...
    if (surface_exists(player.surfacePallete))
        draw_surface(player.surfacePallete, 0, 0);
