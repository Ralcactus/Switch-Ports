...
switch (state)
{
    case UnknownEnum.Value_1:
        ...
        else if (!instance_exists(enemyID) && point_distance(x, 0, obj_parent_player.x, 0) <= xThreshold && point_distance(0, y, 0, obj_parent_player.y) <= yThreshold && (importantEnemy || not_in_list))
        {
