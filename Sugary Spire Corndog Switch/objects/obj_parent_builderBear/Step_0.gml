switch (state)
{
    case UnknownEnum.Value_0:
        ...
        else
        {
            ...
            if (character == UnknownEnum.Value_4 && !global.panic && sprite_index != spr_builderBear_karen_idleAnim && choose(1, 0))
            {
                image_index = 0;
        ...
        else if (sprite_index != spr_builderBear_karen_idleAnim || (sprite_index == spr_builderBear_karen_idleAnim && animation_end()))
        {
            sprite_index = (movespeed >= 1) ? walkSprite : idleSprite;
        }
        
        if (!(character == UnknownEnum.Value_2 || character == UnknownEnum.Value_0 || character == UnknownEnum.Value_1))
            movespeed = 0;
        ...
        if (get_nearestPlayer(x, y).state == UnknownEnum.Value_42 && state != UnknownEnum.Value_1 && bbox_in_camera(self, view_camera[0], 50))
        {
    ...
    case UnknownEnum.Value_1:
        ...
        if (obj_parent_player.state != UnknownEnum.Value_42)
        {
