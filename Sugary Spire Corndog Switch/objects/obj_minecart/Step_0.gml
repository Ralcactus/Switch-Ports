...
if (place_meeting(x, y - 4, _player) && !place_meeting(x, y, obj_minedummycart) && _player.state != UnknownEnum.Value_100)
{
    grabbedMinecart = true;
    global.ComboFreeze = 30;
    _player.state = UnknownEnum.Value_100;
...
if (_player.state == UnknownEnum.Value_100 || place_meeting(x, y, obj_minedummycart))
    image_alpha = 0.5;
else
    image_alpha = 1;
