...
reset = 0;
flash = false;
baddieSpriteIdle = spr_gumjuice;
baddieSpriteStun = spr_gumjuice_stunned;
baddieSpriteWalk = spr_gumjuice;
baddieSpriteTurn = spr_gumjuice;
baddieSpriteGrabbed = spr_gumjuice_stunned;
baddieSpriteScared = spr_gumjuice_scared;
