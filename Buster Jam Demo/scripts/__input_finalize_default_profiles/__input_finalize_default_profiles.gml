function __input_finalize_default_profiles()
{
    ...
    repeat (array_length(_global.__profile_array))
    {
        ...
        repeat (array_length(_profile_verb_names))
        {
            ...
            if (!variable_struct_exists(_global.__basic_verb_dict, _verb_name))
            {
                ...
                variable_struct_set(_global.__basic_verb_dict, _verb_name, true);
                array_push(_global.__all_verb_array, _verb_name);
                variable_struct_set(_global.__all_verb_dict, _verb_name, true);
            }
            ...
            if (array_length(_verb_data) > 4)
                __input_error("Verb \"", _verb_name, "\" for default profile \"", _profile_name, "\" has too many alternate bindings (", array_length(_verb_data), " versus max ", 4, ")\nPlease increase INPUT_MAX_ALTERNATE_BINDINGS if you'd like to use more alternate bindings");
            ...
            repeat (array_length(_verb_data))
            {
                ...
                else
                {
                    ...
                    {
                        case (0 << 0):
                            _global.__any_keyboard_binding_defined = true;
                            break;
                        
                        case (1 << 0):
                            _global.__any_mouse_binding_defined = true;
                            break;
                        
                        case (3 << 0):
                            _global.__any_touch_binding_defined = true;
                            break;
                        
                        case (2 << 0):
                            _global.__any_gamepad_binding_defined = true;
                            break;
                    }
                }
    ...
    if (!variable_struct_exists(_global.__profile_dict, "keyboard_and_mouse"))
        __input_trace("Warning! Default profile for keyboard \"", "keyboard_and_mouse", "\" has not been defined in __input_config_verbs()");
    
    if (!variable_struct_exists(_global.__profile_dict, "keyboard_and_mouse"))
        __input_trace("Warning! Default profile for mouse \"", "keyboard_and_mouse", "\" has not been defined in __input_config_verbs()");
    
    if (!variable_struct_exists(_global.__profile_dict, "gamepad"))
        __input_trace("Warning! Default profile for gamepad \"", "gamepad", "\" has not been defined in __input_config_verbs()");
    
    if (!variable_struct_exists(_global.__profile_dict, "mixed"))
        __input_trace("Warning! Default profile for mixed \"", "mixed", "\" has not been defined in __input_config_verbs()");
    
    if (!variable_struct_exists(_global.__profile_dict, "multidevice"))
        __input_trace("Warning! Default profile for multidevice \"", "multidevice", "\" has not been defined in __input_config_verbs()");
    
    _global.__cursor_verbs_valid = true;
    
    if (!variable_struct_exists(_global.__basic_verb_dict, "aim_up"))
    {
