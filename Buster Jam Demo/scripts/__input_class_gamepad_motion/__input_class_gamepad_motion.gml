function __input_class_gamepad_motion(arg0) constructor
{
    ...
    static __tick = function()
    {
        ...
        switch (0)
        {
            case 21:
                ...
                __accel_y = -switch_controller_acceleration(__index, 2, _sensor);
                ...
                __gyro_y = -degtorad(switch_controller_angular_velocity(__index, 2, _sensor) / 5) * 570.6;
            ...
            case 6:
                ...
                if (is_numeric(_steam_handle))
                {
                    ...
                    __gyro_x = _steam_data.rot_vel_x / 2949.12;
                    __gyro_y = -_steam_data.rot_vel_z / 2949.12;
                    __gyro_z = -_steam_data.rot_vel_y / 2949.12;
                }
