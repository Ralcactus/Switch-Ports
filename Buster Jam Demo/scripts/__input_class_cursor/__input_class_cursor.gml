function __input_class_cursor() constructor
{
    ...
    static __tick = function()
    {
        ...
        var _can_use_mouse = __global.__game_input_allowed && __player.__mouse_enabled && __player.__source_contains(__input_global().__source_mouse);
        ...
        if (__global.__game_input_allowed && __global.__cursor_verbs_valid && (!__global.__pointer_moved || !_can_use_mouse) && __player.__rebind_state <= 0)
        {
            ...
            switch (__coord_space)
            {
                case (0 << 0):
                    ...
                    if (_camera != undefined)
                    {
                        ...
                        _r = (_l + camera_get_view_width(_camera)) - 1;
                        _b = (_t + camera_get_view_height(_camera)) - 1;
