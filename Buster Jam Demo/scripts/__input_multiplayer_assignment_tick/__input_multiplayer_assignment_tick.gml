function __input_multiplayer_assignment_tick()
{
    ...
    repeat (2 - _global.__join_player_max)
    {
    ...
    repeat (_global.__join_player_max)
    {
        if (!input_player_connected(_p))
        {
            ...
            if (_new_source != undefined)
            {
                ...
                if (_global.__join_leave_verb != undefined && input_check_pressed(_global.__join_leave_verb) && input_player_connected_count() < _global.__join_player_min && _global.__join_player_min > 1 && _global.__join_abort_callback != undefined)
                {
