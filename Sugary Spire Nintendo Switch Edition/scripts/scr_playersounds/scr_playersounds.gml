...
function scr_playersounds()
{
	...
	{
		fmod_studio_event_instance_stop(pz_mach1, true)
		fmod_studio_event_instance_stop(pz_mach2_temp, true)
		fmod_studio_event_instance_stop(pz_mach3, true)
		fmod_studio_event_instance_stop(pz_mach4, true)
	}
