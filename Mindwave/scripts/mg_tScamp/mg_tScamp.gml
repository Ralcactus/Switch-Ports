...
function mt0scr_player_tick()
{
    ...
    var spr = mt0_spr_scamp;
    var top_left = [(sprite_get_bbox_left(spr) - sprite_get_xoffset(spr)) + x, (sprite_get_bbox_top(spr) - sprite_get_yoffset(spr)) + y];
    var top_right = [(sprite_get_bbox_right(spr) - sprite_get_xoffset(spr)) + x, (sprite_get_bbox_top(spr) - sprite_get_yoffset(spr)) + y];
    var bottom_left = [(sprite_get_bbox_left(spr) - sprite_get_xoffset(spr)) + x, (sprite_get_bbox_bottom(spr) - sprite_get_yoffset(spr)) + y];
    var bottom_right = [(sprite_get_bbox_right(spr) - sprite_get_xoffset(spr)) + x, (sprite_get_bbox_bottom(spr) - sprite_get_yoffset(spr)) + y];
    ...
    {
        var _triangulated = points_to_triangulated_polygon(arr);
        game.trianglelist = _triangulated;
        var _rect = [top_left[0], top_left[1], bottom_right[0], bottom_right[1]];
        
        if (rectangle_in_triangle_list(_rect[0], _rect[1], _rect[2], _rect[2], _triangulated))
            win();
...
function convert_array_for_point_in_polygon()
{
    var input_array = argument0;
    var output_array = [];
