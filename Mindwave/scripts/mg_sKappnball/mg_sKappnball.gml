...
function mg13_metascript_init()
{
    ...
    var sep = 45;
    var yy = 30;
    blocklist = [[[(4 << 0), startx, yy + 10], [(5 << 0), startx + 139, yy + 10], [(3 << 0), startx + 32, yy], [(6 << 0), startx + 60, yy], [(6 << 0), startx + 79, yy], [(0 << 0), startx + 108, yy], [(1 << 0), startx + 32, yy + 19], [(2 << 0), startx + 70, yy + 19], [(3 << 0), startx + 108, yy + 19]]];
