...
function profile_load(arg0)
{
    with (master)
    {
        if (directory_exists(arg0))
        {
            ...
            {
                show_message("Profile data is corrupt. Settings and unlocks must be reset (Mind Select will be unlocked); story mode save data and high scores may remain intact.\nIf this keeps happening, please get in touch with us at holohammergames@gmail.com");
                profile.unlocks.mind_select_menu = true;
            }
