function charselect_character_constructor() constructor
{
    ...
    enter_game = function()
    {
        if (obj_mainmenu_controller.transition_happening)
            exit;
            ...
            mgc.after_start = function()
            {
                ...
                with (obj_minigame_controller)
                {
                    ...
                    with (char)
                    {
                        ...
                        {
                            results_screen_menu.add_sprite_button(spr_endlessbtn_submitscore, function()
                            {
                                instance_create_depth(0, 0, 0, eventdemo_after_endless);
                                instance_destroy(obj_minigame_controller);
                            }, 0, 0);
                        }
                        else
