function cutscene_constructor() constructor
{
    ...
    _tick = function()
    {
        ...
        else
        {
            ...
            if (queued_sequence_event != _ev && queued_sequence_event != -1 && _ev.pause_menu.active != queued_sequence_event.user_paused)
            {
                queued_sequence_event._user_set_pause(_ev.pause_menu.active);
                queued_sequence_event.pause_menu.active = false;
            }
        }
    };
